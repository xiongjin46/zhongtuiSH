 ...
 * @Description: 线程组件公告类 网络线程池 文件操作线程
 * @author: YYL
 *
 * create at 2016/11/10 14:56
 */
public final class
ThreadManager {
    ...
    public static Handler getFileThreadHandler() {
        if (FILE_THREAD_HANDLER == null) {
            synchronized (ThreadManager.class) {
                ...
                FILE_THREAD = new HandlerThread("WN_FILE_RW");
                FILE_THREAD.start();
    ...
    public static void executeOnFileThread(Runnable run,long delayMillis){
        getFileThreadHandler().postDelayed(run,delayMillis);
    }
