...
import com.push.PushMerchant.weight.wheel.view.LoopView;
import com.push.PushMerchant.weight.wheel.view.OnItemSelectedListener;
...
final class WheelOptions {
            ...
            wv_option2.setListener(new OnItemSelectedListener() {
                ...
                public void onItemSelected(int index) {
                    ...
                    if (wv_option1.getSelectedItem() < mOptions3Items.size()) {
                        ArrayList<ArrayList<String>> allItems3 = mOptions3Items.get(wv_option1.getSelectedItem());
    ...
    private void doItemChange() {
        if (mOnOptionChangedListener != null) {
            ...
            mOnOptionChangedListener.onOptionChanged(option1, option2, option3,0);
        }
    }
